...
import { Plug, Globe, Zap, GitBranch, Play, ShieldOff } from 'lucide-react';
import { GitBranchInfo } from './ui/GitBranchInfo';
...
export function SessionCard({
  ...
  const { isPlan, displayTitle } = formatSessionTitle(session.session_title, { stripCommands: true, maxLength: 60 });
